...
#####################################################
#This runs the gtools: gtselect, gtmktime, gtbin, gtexp, ...
gta.setup() 
gta.print_model()
...
gta.sed(gta.roi.sources[0].name, loge_bins=gta.log_energies[::2], outfile='PSR_SED.fits',free_background=True,write_npy=True,make_plots=True,write_fits=True)
